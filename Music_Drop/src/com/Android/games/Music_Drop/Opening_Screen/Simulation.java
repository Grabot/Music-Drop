...
{   
        ...
        {
                Gdx.app.log( Simulation.LOG, "Opening Screen populated" );
        }
        ...
        private void Add_Red_ScoreBall( )
        {
    		...
    		//Gdx.app.log( Simulation.LOG, "red scoreball: " + red_scoreballs.size() + " at point: " + point );
        }
        ...
        private void Add_Yellow_ScoreBall( float x, float y )
        {
    		...
    		//Gdx.app.log( Simulation.LOG, "yellow scoreball: " + yellow_scoreballs.size() + " at point: " + point  );
        }
        ...
        private void Add_Blue_ScoreBall()
        {
    		...
    		//Gdx.app.log( Simulation.LOG, "blue scoreball: " + blue_scoreballs.size() + " at point: " + point );
        }
        ...
        private void Add_Green_ScoreBall()
        {
    		...
    		//Gdx.app.log( Simulation.LOG, "green scoreball: " + green_scoreballs.size() );
        }
        ...
        {  
        	...
        	//Gdx.app.log( Simulation.LOG, "touch postion x: " + touch_distance_x + " touch position y: " + touch_distance_y );
        	
        	if(( touch_distance_x > -125) && (touch_distance_x < 125 ))
        	{
        		if(( touch_distance_y > -120 ) && ( touch_distance_y < -50 ))
        		{
        			play_game_touched = true;
        		}
        	}
        	
        	if( !touched_down && play_game_touched )
        	{
